...
<c:param name="menu_id" value="203"></c:param>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>订单列表</strong> </div> 
  <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
   ...
   <table width="100%" border=0>
    ...
    <td width="15%" align="right">下单日期:</td> <td width="45%" ><input class="inpMain Wdate" id="addtime_start" value="${param.addtime_start}" style='width:140px;height=15px;' type="text" name="addtime_start" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>--<input type="text"  id="addtime_end" name="addtime_end" class="inpMain Wdate"  style='width:140px;' value="${param.addtime_end}"onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"/> </td>
    </tr>
      <tr>
    <td   align="right">用户名:</td> <td width="25%"> <input type="text"  name="username"  id="username"  class="inpMain" value="${param.username}"  style='width:180px;'/></td>
   </tr>
   <tr>
   <td ></td>
